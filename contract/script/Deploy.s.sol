...
contract DeployScript is Script {
    function run() external {
        ...
        // Copy ABIs
        vm.copyFile(
            "out/Proposals.sol/Proposals.json", 
            "../interface/src/deployments/Proposals.sol/Proposals.json"
        );
        vm.copyFile(
            "out/DEAL.sol/DEAL.json", 
            "../interface/src/deployments/DEAL.sol/DEAL.json"
        );
        vm.copyFile(
            "out/MockUSDS.sol/MockUSDS.json", 
            "../interface/src/deployments/USDS/USDS.json"
        );
        vm.copyFile(
            "out/MockUSDC.sol/MockUSDC.json", 
            "../interface/src/deployments/USDC/USDC.json"
        );
        vm.copyFile(
            "out/MockUSDT.sol/MockUSDT.json", 
            "../interface/src/deployments/USDT/USDT.json"
        );
